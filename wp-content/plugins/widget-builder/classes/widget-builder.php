...
// End register_post_type()
        ...
        public function meta_box_setup() {
            ...
            add_meta_box(
                    self::TOKEN . '_publish', __('Publish', 'widget-builder'), array(&$this, 'meta_box_publish'), self::TOKEN, 'side', 'high'
            );

            // add link details
            add_meta_box(
                    self::TOKEN . '_link_details', __('Widget Link Details', 'widget-builder'), array(&$this, 'meta_box_content'), self::POST_TYPE, 'side', 'default'
            );

            // add internal widget details
            add_meta_box(
                    self::TOKEN . '_widet_details', __('Widget Admin Details', 'widget-builder'), array(&$this, 'meta_box_widget'), self::POST_TYPE, 'normal', 'low'
            );
